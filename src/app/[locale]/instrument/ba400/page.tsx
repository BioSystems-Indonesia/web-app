        ...
        <div className="ba400">
            ...
            <main>
                ...
                <section aria-labelledby="images-heading">
                    <h2 className="sr-only" id="images-heading">BioSystems BA400 Product Images</h2>
                ...
                <section aria-labelledby="specifications-heading">
                    ...
                    <article className="article">
                        <motion.div {...fadeRight}>
                            <Image src={BACenter} alt="BioSystem BA400 Analyzer" className="center" />
                        </motion.div>
                ...
                <section aria-labelledby="detail-images-heading">
                    ...
                    <div className="images-detail">
                        <div className="card-images">
                            <Image src={Detail1} alt="BioSystems BA400 Control Panel Detail" />
                            <Image src={Detail2} alt="BioSystems BA400 Sample Tray Detail" />
                        </div>
                    </div>
                </section>
                <section aria-labelledby="product-details-heading">
                    ...
                    <div className="specs-detail">
                        ...
                        <div>
                            ...
                            <div className="body">
                                <p className="code">83400/83400ISE</p>
                            </div>
                        </div>
                    </div>
                </section>
